...
urlpatterns = [
    ...
    path('carsa/<int:pk>/update', CarUpdateView.as_view(), name='car-update'),
    path('carsaa/<int:pk>/delete', CarDeleteView.as_view(), name='car-delete'),
    path('bulk-delete/', BulkDeleteAPIView.as_view(), name='car-bulk-delete'),
    path('carlist/', carlistView.as_view(), name='cars-list'),
    path('carslist/', carsListView.as_view(), name='cars-lists')
    ]